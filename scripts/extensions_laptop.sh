...
# Hide Top Bar
wget -P /tmp https://extensions.gnome.org/extension-data/hidetopbarmathieu.bidon.ca.v117.shell-extension.zip
unzip -d /tmp/tmpdir /tmp/hidetopbarmathieu.bidon.ca.v117.shell-extension.zip
